<template>
    <div style="height: 100%; position: absolute; min-width: 100%" class="is-flex pt-6 is-align-items-start is-justify-content-center is-flex-direction-row columns mx-0 Popins has-text-weight-semibold">
